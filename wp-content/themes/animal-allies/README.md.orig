...
* This repository holds the Animal Allies Theme
* The contents can be placed in a directory under the
* /themes folder of a WordPress installation.
...
>>>>>>> 61a1a55a8e145cccf307934fef58cfadf2abeaa9
